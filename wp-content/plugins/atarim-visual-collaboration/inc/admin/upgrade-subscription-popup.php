...
<div class="wpf-uf-pop-wrapper">
    <div class="wpf-uf-pop-container">
        <div class="wpf-uf-popup">
            ...
            <div class="wpf-uf-popup-title"><?php _e( "Let's Unlock This Feature", 'atarim-visual-collaboration' ); ?></div>
            <p><?php _e( 'Unlock this feature and improve your workflow even further by upgrading your plan.', 'atarim-visual-collaboration' ); ?></p>
            <div class="wpf-uf-popup-plans">
                ...
                <div class="wpf-uf-plan">
                    ...
                    <a class="wpf-uf-plan-link" href="#" target="_blank"><div class="wpf-uf-plan-btn"><?php _e( 'Upgrade To Unlock', 'atarim-visual-collaboration' ); ?></div></a>
                </div>
            </div>
            <div class="wpf-uf-webmaster-notice"><?php _e( '*This is only shown to you as a webmaster, other users will not see this', 'atarim-visual-collaboration' ); ?></div>
            <div class="wpf-uf-otheruser-notice"><?php _e( 'Please contact your webmaster to unlock this feature', 'atarim-visual-collaboration' ); ?></div>
        </div>
    </div>
</div>