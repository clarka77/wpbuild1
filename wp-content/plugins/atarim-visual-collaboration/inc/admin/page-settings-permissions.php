<div class="wrap wpfeedback-settings">
    ...
    <div class="wpf_tabs_container" id="wpf_tabs_container">
        ...
        <!--<button class="wpf_tab_item wpf_graphics" onclick="location.href='admin.php?page=wpfeedback_page_graphics'" style="background-color: #efefef;"><?php _e( 'Graphics', 'atarim-visual-collaboration' ); ?></button>-->
        <?php 
        ...
        <?php }
        if ( $wpf_user_type == 'advisor' || ( $wpf_user_type == '' && current_user_can( 'administrator' ) ) ) { ?>
            <button class="wpf_tab_item wpf_misc" onclick="openWPFTab('wpf_misc')" style="background-color: #efefef;"><?php _e( 'Permissions', 'atarim-visual-collaboration' ); ?></button>
        <?php }
    ...
    if ( $wpf_user_type == 'advisor' || ( $wpf_user_type == '' && current_user_can( 'administrator' ) ) ) { ?>
        <div id="wpf_misc" class="wpf_container" style="display:none">
            <div class="wpf_section_title"><?php _e( 'Permissions', 'atarim-visual-collaboration' ); ?></div>
                ...
                <div class="wpf_settings_ctt_wrap">
					<div class="wpf_settings_sidebar">
                        <div class="wpf_settings_inner_sidebar">
                            <a href="#wpf_license_ver"><?php _e( 'Agency Dashboard Integration', 'atarim-visual-collaboration' ); ?></a>
                            <a href="#wpf_general_perm"><?php _e( 'Permissions Settings', 'atarim-visual-collaboration' ); ?></a>
                            <a href="#wpf_user_custom"><?php _e( 'Customisations', 'atarim-visual-collaboration' ); ?></a>
                            <a href="#wpf_user_perm"><?php _e( 'User Permissions', 'atarim-visual-collaboration' ); ?></a>
                            <a href="#wpf_default_users"><?php _e( 'Default Users', 'atarim-visual-collaboration' ); ?></a>
                            <?php _e( 'Remember to Save Changes at the bottom of this screen to apply any changes.', 'atarim-visual-collaboration' ); ?>
                        </div>
                    </div>										
                    <div class="wpf_settings_col">
                        <div class="wpf_inner_settings_col">
                            <div class="wpf_title_section" id="wpf_license_ver"><?php _e( 'Agency Dashboard Integration', 'atarim-visual-collaboration' ); ?></div>
                            <p><?php _e( 'Click the button to activate and add this website to your Agency Dashboard. If for some reason the connection is not established, please contact support.', 'atarim-visual-collaboration' ); ?></p>
                            <div class="wpfeedback_licence_key">
                                <div class="wpf_title"><?php _e( 'Add this website to your Agency Dashboard account', 'atarim-visual-collaboration' ); ?></div>
                                <span><?php _e( 'The Client Interface Plugin will not work unless you click the following button and activate this website.', 'atarim-visual-collaboration' ); ?></span>
                                <div class="wpfeedback_licence_key_field">
                                    ...
                                    if ( $status !== false && $status == 'valid' ) {
                                        ...
                                        echo '<input type="submit" class="wpf_deactivate_button" name="edd_license_deactivate" value="'.__( "Deactivate License", 'atarim-visual-collaboration' ).'"/></div>';
                                    } else {
                                ...
                                <span><?php _e( "If you ran out of website slots, <a href='https://atarim.io/upgrade/' target='_blank'>Please click here to increase your resources</a>", 'atarim-visual-collaboration' ); ?></span>
                                <?php 
                                $wpf_check_license_site = get_option( 'wpf_license' );
                                if ( $wpf_check_license_site == 'site_inactive' ) {
                                    ?>
                                    <p style="color: red;"> <?php _e( "Your license has been manually revoked from Atarim account. If you feel that this is a mistake, please contact the license owner to manually add the license to the site.", 'atarim-visual-collaboration' ); ?></p>
                                <?php } ?>
                            </div>
                            <div class="wpf_title_section" id="wpf_general_perm"><?php _e( 'Permissions Settings', 'atarim-visual-collaboration' ); ?></div>
                            <div class="wpf_settings_option wpfeedback_user_role_list">
                                <div class="wpf_title"><?php _e( 'User roles allowed to create tasks', 'atarim-visual-collaboration' ); ?></div>
                                <div class="wpf_description"><?php _e( 'If a user role is not selected, they will not be able to see Atarim Client Interface on the front-end, they will still be able to access the plugin settings though unless you restrict this someone else.', 'atarim-visual-collaboration' ); ?></div>
                                <select multiple="true" id="wpfeedback_user_role_list" name="wpfeedback_selcted_role[]"><?php echo wpfeedback_dropdown_roles(); ?></select>
                                <div class="wpf_description"><?php _e( "Hold down the CTRL key to choose multiple options.", 'atarim-visual-collaboration' ); ?></div>
                            </div>
                            <div class="wpf_settings_option wpfeedback_guest_allowed">
                                <div class="wpf_title"><?php _e( 'Guest Mode', 'atarim-visual-collaboration' ); ?></div>
                                <div class="wpf_description"><?php _e( 'Enabling this will make Atarim Client Interface visible to everyone who visits your site and will allow them to create tasks and comment on existing ones.', 'atarim-visual-collaboration' ); ?></div>
                            ...
                            <div class="wpf_settings_option wpfeedback_disable_for_admin">
                                <div class="wpf_title"><?php _e( 'Stop comments for admins', 'atarim-visual-collaboration' ); ?></div>
                                <div class="wpf_description"><?php _e( 'Stop comments for admins on front end.', 'atarim-visual-collaboration' ); ?></div>
                            ...
                            <div class="wpfeedback_customisations">
                                <div class="wpf_title_section" id="wpf_user_custom"><?php _e( 'Customisations ', 'atarim-visual-collaboration' ); ?></div>
                                <p><?php _e( 'These names are for the setup wizard when you first installed the plugin. Every user who comes to the website after installation will have to go through it and you can name the 3 options here.', 'atarim-visual-collaboration' ); ?></p>
                                <div class="wpf_settings_option">
                                    <div class="wpf_title"><?php _e( 'Client (Website Owner) ', 'atarim-visual-collaboration' ); ?></div>
                                    <div class="wpf_description"><?php _e( 'Can do everything except: Choose and change status, access the settings, support and upgrade screens. Can only delete their own tickets.', 'atarim-visual-collaboration' ); ?></div>
                                ...
                                <div class="wpf_settings_option">
                                    <div class="wpf_title"><?php _e( 'Webmaster', 'atarim-visual-collaboration' ); ?></div>
                                    <div class="wpf_description"><?php _e( 'Super admin – Has full capabilities for all the plugin’s functions. ', 'atarim-visual-collaboration' ); ?></div>
                                ...
                                <div class="wpf_settings_option">
                                    <div class="wpf_title"><?php _e( 'Others ', 'atarim-visual-collaboration' ); ?></div>
                                    <div class="wpf_description"><?php _e( 'Can do everything except: Choose and change status and urgency, Access the settings, support, integration and upgrade screens. Can only delete their own tickets. ', 'atarim-visual-collaboration' ); ?></div>
                            ...
                            <div class="wpf_title_section" id="wpf_user_perm"><?php _e( 'User Permissions', 'atarim-visual-collaboration' ); ?></div>
                            <!--edited by Pratap-->
                            ...
                            if ( get_option( "wpf_global_settings" ) == 'yes' ) {
                                ...
                                <div class="at_feature_lock_wrap wpf_global_lock">
                                    ...
                                    <div class="at_feat_content">
                                        <div class="wpf_title"><?php _e( 'Global Settings', 'atarim-visual-collaboration' ); ?></div>
                                        <p><?php _e( 'User Permissions are pulled from your Agency dashboard', 'atarim-visual-collaboration' ); ?></p>
                                ...
                                ?>
                                <p><?php _e( 'Enable or disable diffent functionality based on the Atarim user types to overwirte the default settings and customise your workflow.', 'atarim-visual-collaboration' ); ?></p>
                                <table class="wpf_perm_table">
                                    <tr>
                                        <td class="wpf_perm_top"></td>
                                        <td class="wpf_perm_top"><?php echo get_site_data_by_key( 'wpf_customisations_client' ) ? get_site_data_by_key( 'wpf_customisations_client' ) : _e( 'Client (Website Owner) ', 'atarim-visual-collaboration' ); ?></td>
                                        <td class="wpf_perm_top"><?php echo get_site_data_by_key( 'wpf_customisations_webmaster' ) ? get_site_data_by_key( 'wpf_customisations_webmaster' ) : _e( 'Webmaster', 'atarim-visual-collaboration' ); ?></td>
                                        <td class="wpf_perm_top"><?php echo get_site_data_by_key( 'wpf_customisations_others' ) ? get_site_data_by_key( 'wpf_customisations_others' ) : _e( 'Others ', 'atarim-visual-collaboration' ); ?></td>
                                        <td class="wpf_perm_top"><?php _e( 'Guest ', 'atarim-visual-collaboration' ); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Add User', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Priority', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Status', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Screenshot', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Information', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Delete', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Auto Screenshot', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Color Coded Stickers', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Display Number On Completed Task', 'atarim-visual-collaboration' ); ?>
                                    ...
                                    <tr>
                                        <td class="wpf_left_cell"><?php _e( 'Keyboard Shortcuts', 'atarim-visual-collaboration' ); ?>
                            ...
                            ?>
                            <div class="wpf_title_section" id="wpf_default_users"><?php _e( 'Default Users', 'atarim-visual-collaboration' ); ?></div>
                            <div class="wpf_settings_option wpf_website_developer">
                                <div class="wpf_title"><?php _e( 'The website builder', 'atarim-visual-collaboration' ); ?></div>
                                <div class="wpf_description"><?php _e( 'The website builder will add this user to all tasks by default, allowing the client to skip the "choose a user" tab when creating a task. It will also be used for the Auto Login option when coming from the Agency Dashboard.', 'atarim-visual-collaboration' ); ?></div>
                                <select name="wpf_website_developer">
                                    <option value="0"><?php _e( 'select', 'atarim-visual-collaboration' ); ?></option>
                                    <?php
                                ...
                                <div class="wpf_description"><?php _e( "This will probably be your own user, as the person or agency that is building the website.", 'atarim-visual-collaboration' ); ?></div>
                            </div>
                            <div class="wpf_settings_option wpf_website_client">
                                <div class="wpf_title"><?php _e( 'The client', 'atarim-visual-collaboration' ); ?></div>
                                <div class="wpf_description"><?php _e( 'Create a user for the client and assign it here to allow the client to comment in guest mode but still be assigned to the tickets for replies and notifications.', 'atarim-visual-collaboration' ); ?></div>
                                ...
                                <div class="wpf_description"><?php _e( "This will be the user you created for your main contact for this website.", 'atarim-visual-collaboration' ); ?></div>
                            </div>
