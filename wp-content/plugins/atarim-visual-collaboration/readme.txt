...
Tags: collaboration, feedback, bug-tracking, project management, screenshots, support, team, management, task management, communication tool, feedback, bug tracking, sticky note, website feedback, visual feedback, clients, communication, customer communication, share, designs, ads, agency, collaborate, client communication
...
1. **Comment Mode**: Click the plus icon on the front end of the website to highlight a section of the page and leave a request.
2. **Creating Requests**: Add your first comment and create the request on the section.
...
= v3.9.4 =
* **Vulnerable to Cross-Site Scripting** - Our discontinued Graphic collaboration inside the plugin had a small XSS vulnerability. This is now fixed.
